classdef I2C_Servo_pHAT
    ...
    methods
        function obj = I2C_Servo_pHAT(raspberry_pi)
            ...
            PRE_SCALE = round(I2C_Servo_pHAT.HW_CLOCK_FREQ/(4096*I2C_Servo_pHAT.DEFAULT_SERVO_FREQUENCY))-1;
        ...
        function freq = getServoFrequency(obj)
            ...
            freq = round(I2C_Servo_pHAT.HW_CLOCK_FREQ/((PRE_SCALE+1)*4096));
        end
        function new_servo_freq = setServoFrequency (obj,freq)
            ...
            PRE_SCALE = round(I2C_Servo_pHAT.HW_CLOCK_FREQ/(4096*freq))-1;
            writeRegister(obj.device, 0xFE, PRE_SCALE);
